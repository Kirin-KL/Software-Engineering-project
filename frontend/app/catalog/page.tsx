              ...
              sortedBooks.map((book) => (
                <Link href={`/product/${book.id}`} key={book.id}>
                  <Card className={viewMode === "grid" 
                    ? "h-[480px] hover:shadow-lg transition-shadow duration-200 flex flex-col"
                    : "hover:shadow-lg transition-shadow duration-200 flex flex-row h-[220px]"
                  }>
                    <div className={viewMode === "grid" ? "w-full" : "w-[200px] flex-none"}>
                      <div className={viewMode === "grid" 
                        ? "w-full h-[180px] bg-gray-200 rounded-lg flex items-center justify-center mb-3"
                    ...
                    <div className={viewMode === "grid" ? "flex-grow" : "flex-grow p-4 flex flex-col"}>
                      <CardHeader className={viewMode === "grid" ? "flex-none p-3" : "flex-none p-0 mb-2"}>
                        <CardTitle className="line-clamp-2 text-lg mb-1">{book.title}</CardTitle>
                        <CardDescription className="line-clamp-1">{book.author}</CardDescription>
                      </CardHeader>
                      <CardContent className={viewMode === "grid" 
                        ? "flex-grow flex flex-col p-3 pt-0"
                        : "flex-grow flex flex-col p-0"
                      }>
                        <div className="flex items-center gap-2 mb-2 flex-none h-[24px]">
                        ...
                        <p className={viewMode === "grid" 
                          ? "text-sm text-gray-600 line-clamp-3 flex-grow min-h-[60px]"
